...
export const TOKENS: Token[] = [
  ...
  { id: "event-workshop", css: "--event-workshop", label: "Workshop", group: "The diary", fallback: "#9f6aaf" },
  { id: "event-training", css: "--event-training", label: "Training", group: "The diary", fallback: "#b49ddb" },
  ...
  { id: "kind-masterclass", css: "--kind-masterclass", label: "Masterclass", group: "Learning sessions", fallback: "#7a86cb" },
  { id: "kind-lunch-and-learn", css: "--kind-lunch-and-learn", label: "Lunch and learn", group: "Learning sessions", fallback: "#7a86cb" },
  { id: "kind-critique", css: "--kind-critique", label: "Critique", group: "Learning sessions", fallback: "#7a86cb" },
  { id: "kind-training", css: "--kind-training", label: "Training", group: "Learning sessions", fallback: "#7a86cb" },
