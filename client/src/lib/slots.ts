    ...
    groups: [
      ...
      },
      {
        ...
        slots: [
          ...
          column("deadlines.column.season", "Forecast horizon"),
    ...
    groups: [
      ...
      },
      {
        ...
        slots: [
          ...
          field("content.facts.season", "Forecast horizon"),
    ...
    groups: [
      {
        ...
        slots: [
          ...
          t("builder.canvas", "Drag a node in to start building"),
          section("builder.palette", "Nodes"),
    ...
    groups: [
      {
        ...
        label: "Page heading",
        slots: [t("notifications.eyebrow", "You"), t("notifications.title", "Alerts")],
      },
    ],
  },
    ...
    groups: [
      {
        id: "settings.head",
        label: "Page heading",
        slots: [t("settings.eyebrow", "You"), t("settings.title", "Settings")],
      },
    ],
  },
