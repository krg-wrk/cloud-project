...
export const ICON_PATHS: Record<string, string> = {
  ...
  // The Forecast Lab
  builder: "M4 5h6v6H4zM14 5h6v6h-6zM4 15h6v4H4zM14 15h6v4h-6zM10 8h4M10 17h4M7 11v4M17 11v4",
  atom: "M12 12h.01M21.5 12A9.5 3.4 0 1 1 2.5 12 9.5 3.4 0 1 1 21.5 12M16.75 20.23A9.5 3.4 60 1 1 7.25 3.77 9.5 3.4 60 1 1 16.75 20.23M7.25 20.23A9.5 3.4 120 1 1 16.75 3.77 9.5 3.4 120 1 1 7.25 20.23",
  media: "M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1ZM10 9.5v5l4.5-2.5L10 9.5Z",
  feed: "M5 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM4 4a16 16 0 0 1 16 16M4 10.5A9.5 9.5 0 0 1 13.5 20",
  brief: "M9 3h6v3H9zM8 4.5H6a1 1 0 0 0-1 1V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V5.5a1 1 0 0 0-1-1h-2M9 11h6M9 15h4",
  driver: "M12 3v7M12 14v7M5 7.5 12 10l7-2.5M5 16.5 12 14l7 2.5M12 12.5a1.3 1.3 0 1 0 0-2.6 1.3 1.3 0 0 0 0 2.6ZM4 8.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM20 8.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM4 18.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM20 18.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z",
  score: "M12 3.5l2.6 5.3 5.9.9-4.2 4.1 1 5.8-5.3-2.8-5.3 2.8 1-5.8L3.5 9.7l5.9-.9L12 3.5Z",
  /** On anything that leaves the Hub. The arrow is the whole point. */
  ...
  // Points down when a group is open and is rotated a quarter turn when shut,
  // so the same glyph is both states and cannot disagree with itself.
  ...
  camera:
    "M4 7.5h3L8.5 5h7L17 7.5h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1ZM12 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z",
  person: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",
  info: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 11v5.5M12 7.6h.01",
  download: "M12 3.5v11M7.5 10.5 12 15l4.5-4.5M4.5 17.5v1a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-1",
