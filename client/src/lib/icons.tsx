...
export const ICON_PATHS: Record<string, string> = {
  ...
  atom: "M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM12 3c4.4 0 8 4 8 9s-3.6 9-8 9-8-4-8-9 3.6-9 8-9ZM4.2 8.5c-1 1.7 2.7 5 8.3 7.5s10.5 3.1 11.3 1.4M19.8 8.5c1 1.7-2.7 5-8.3 7.5S1 19.1.2 17.4",
